    ...
    public ScoringCard_1() {
        ...
        JTable table1 = new JTable(
                new Object[][] { { "", "ROOSEVELT(sum of all USA dice, less axis)", "" },
                        { "", "STALIN(sum of all USSR dice, less axis )", "" },
                        { "", "CHURCHILL(sum of all UK dice, less axis)", "" },
                        { "", "KAI SHAK(sum of all China dice, less axis)", "" },
                        { "", "Daladier(sum of all France dice, less axis)", "" }, { "", "SUBTOTAL", "" },
                        { "50", "ENOLA GAY(bonus more than 65 in upper section", "" } },
