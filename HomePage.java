...
class HomePage extends JPanel {
    ...
    public HomePage() {
        ...
        JLabel label2 = new JLabel("<html>Your goal is to bring the <strong>ALLIES</strong> to victory over the <strong>AXIS POWERS</strong> alliance by scoring as many points as possible!");
        ...
        JLabel label3 = new JLabel("<html>If you’ve already been briefed, click <strong>PLAY</strong> to begin now! Otherwise, select <strong>INSTRUCTIONS</strong> to learn about your mission!");
        ...
        Button playButton = new Button("PLAY", 22, Color.WHITE, Color.decode("#585a5d"), Color.decode("#bb0056"), new ActionListener(){  
        ...
        Button helpButton = new Button("INSTRUCTIONS", 22, Color.WHITE, Color.decode("#585a5d"), Color.decode("#ffc000"), new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
        ...
        Button exitButton = new Button("EXIT", 22, Color.WHITE, Color.decode("#585a5d"), Color.decode("#52793b"), new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
